...
//  BeReal.
//
//  Created by Aaron Jacob on 3/27/23.
//
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    enum Constants {
        static let authenticationViewControllerIdentifier = "AuthenticationViewController"
        static let navigationControllerIdentifier = "NavigationController"
        static let createPostViewControllerIdentiifer = "CreatePostViewController"
    ...
    private func logout() {
        ...
        let storyboard = UIStoryboard(name: Constants.storyboardIdentifier, bundle: nil)
        self.window?.rootViewController = storyboard.instantiateViewController(withIdentifier: Constants.authenticationViewControllerIdentifier)
    }
}
